 ...
 */
export default function scrollZoomHandler(map, options) {
  ...
  function start() {
    ...
    if (!zooming) {
      zooming = true;
      fireEvent('movestart', _lastWheelEvent);
      fireEvent('zoomstart', _lastWheelEvent);
    }
  ...
  function onScrollFrame() {
    ...
    fireEvent('move', _lastWheelEvent);
    fireEvent('zoom', _lastWheelEvent);
    ...
    if (finished) {
      ...
      _finishTimeout = setTimeout(() => {
        ...
        fireEvent('zoomend', _lastWheelEvent);
        fireEvent('moveend', _lastWheelEvent);
